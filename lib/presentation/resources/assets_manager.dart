...
class ImageAssets {
  ...
  // static const String onboardingLogo1 = "$IMAGE_PATH/ek1.jpeg";
  // static const String onboardingLogo2 = "$IMAGE_PATH/ek2.jpeg";
  // static const String onboardingLogo3 = "$IMAGE_PATH/ek3.jpeg";
  // static const String onboardingLogo4 = "$IMAGE_PATH/ek4.jpeg";
...
class JsonAssets {
  ...
  static const String alert = "$JSON_PATH/alert.json";
  static const String loading_spinner = "$JSON_PATH/loading-spinner.json";

  static const String anonymous = "$JSON_PATH/anonymous.json";
  static const String multiple = "$JSON_PATH/multiple.json";
  static const String report = "$JSON_PATH/report.json";
  static const String notification = "$JSON_PATH/notifications.json";
  static const String subscription = "$JSON_PATH/subscription.json";
}
